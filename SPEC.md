...
| `report` | evaluation JSON | `outputs/final_report.md` | 输出最终分析报告 |
...
| `report` | 已接入并全量重跑 | `src/main.py` `IMPLEMENTED` | 生成课堂展示版 `outputs/final_report.md` |
...
| report | written=1 | `outputs/final_report.md` 可直接用于课堂展示 |
